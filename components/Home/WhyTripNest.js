	...
	return (
		<>
			<div className="container-custom w-full grid grid-cols-1 md:grid-cols-2 ">
				<div className="basis-[50%]  flex flex-col justify-start items-start gap-y-4 h-full w-full relative ">
					<div className=" flex-col-start">
						...
						/>
						<span className=" font-semibold text-[26px] text-teal_blue ">
							TripNest is Your Trusted Travel Companion
						</span>
						<p className=" font-light text-[16px] mt-2">
						...
						<div className="basis-[50%]  flex flex-col justify-center items-start gap-y-6">
							<div className=" flex justify-center items-center gap-2">
								<Image
									...
									// className="object-contain"
								/>
								<span className=" text-sm">Comprehensive Visa Information</span>
							</div>
							<div className=" flex justify-center items-center gap-2">
								<Image
									className="w-[24px] h-[24px] "
						...
						<div className="basis-[50%]  flex flex-col justify-center items-start gap-y-6 ">
							<div className=" flex justify-center items-center gap-2">
								<Image
									...
									// className="object-contain"
								/>
								<span className=" text-sm">Secure and Easy Booking</span>
							</div>
							<div className=" flex justify-center items-center gap-2">
								<Image
									className="w-[24px] h-[24px] "
					...
					<div>
						<Button
							...
							containerStyles="custom-btn-fill text-[11px] mt-4"
						/>
					</div>
					{/* <Image
					...
					<div className=" w-full flex justify-end items-center  gap-4">
						<div className="flex flex-col justify-between items-center gap-4">
							<div className=" w-[220px] h-[103px] bg-sky-blue flex-center-col text-white rounded-md">
								{/* // <span>250+</span> */}
								<span>
									{<CountUp delay={0.2} end={250} duration={5.75} />} +
								</span>
